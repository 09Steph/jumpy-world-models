...
FIGURE_REGISTRY: tuple[FigureSpec, ...] = (
    ...
    FigureSpec("F0.4b", "fig:e3_slip_gaps",
               "Paired arm gap under increasing stochasticity",
               "0", panels.build_slip_gaps),
    ...
    FigureSpec("F2.8", "fig:compounding_error_sum",
               "Compounding error by condition, plain sum",
               "2", panels.build_compounding_sum),
    FigureSpec("F2.8b", "fig:compounding_error_discounted",
               "Compounding error by condition, discounted integral",
               "2", panels.build_compounding_discounted),
